...
const RelatedFarmerInspectionDatatable = ({params}) => {
    ...
    const GetFarmerInspections = async () => {
        setLoaded(false);
        const url = base_url + `/api/Farmer/FarmerRelatedInspections?farmerId=${farmerId}`;
...
export default RelatedFarmerInspectionDatatable