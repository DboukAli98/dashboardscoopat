...
const RelatedUserInspectionDatatable = ({params}) => {
    const userId = params;
    ...
    const getUserRelatedInspections = async () => {
        setLoaded(false);
        const url = base_url + `/api/Inspections/GetEmployeeInspections?employeeId=${userId}`;
...
export default RelatedUserInspectionDatatable;
